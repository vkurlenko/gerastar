...
{
	echo '<span class="msgOk">На адрес '.$_VARS['env']['subscribe_mail_test'].' отправлено тестовое письмо-рассылка</span>';
...
{
	echo '<span class="msgError">Рассылка остановлена</span>';
...
<form action="" method="post">
	...
	<input type="submit" name="doTest" value="Отправить тестовое письмо" />
	<input type="submit" name="do" value="Запустить новую рассылку" style="font-weight:bold" />
</form>
...
?> 
<form action="" method="post">
	<input type="submit" name="stop" value="Остановить рассылку"  <?=$dis?> />	
</form>
</fieldset>
...
if(!isset($editItem) && !isset($setItem))
{
	...
	<div>
	<?
	/* загрузка списка адресов из файла .txt */
	...
	<form action="" method="post" enctype="multipart/form-data">
		Загрузить список из текстового файла (.txt): <input type="file" name="list" style="border:1px solid silver">
