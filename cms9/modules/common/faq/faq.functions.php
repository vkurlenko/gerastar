	...
	mb_internal_encoding("UTF-8");
		...
		while($row = mysql_fetch_array($res))
		{
			?><tr>				
				...
				<td><?=$row['faqDate']?></td>
				<td align="center"><?=iconChkBox($_MODULE_PARAM['tableName'], 'faqAnswer', $row['faqAnswer'], $row['id']);?></td>
				<td align="center"><?=iconChkBox($_MODULE_PARAM['tableName'], 'faqShow', $row['faqShow'], $row['id']);?></td>			
