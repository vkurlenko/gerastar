...
include_once $_SERVER['DOCUMENT_ROOT'].'/cms9/modules/framework/f.php';
...
<script language="javascript" type="text/javascript" src="/cms9/js/script.js"></script>
...
if ($razdels){
	...
	foreach ($razdels as $key => $razdel)
	{
		...
		<tr <?=$bgc;?> valign="middle">
			...
			<td align="center"><a href='/cms9/razdel/index.php?parent=<?=$parent?>&move_down=<?=$razdel['id']?>' title='вниз'><img src='<?=$_ICON["down"]?>'></a><a href='/cms9/razdel/index.php?parent=<?=$parent?>&move_up=<?=$razdel['id']?>' title='вверх'><img src='<?=$_ICON["up"]?>'></a></td>
			<td><?=iconChkBox($tableName, 'p_main_menu', $razdel['p_main_menu'], $razdel['id']);?></td>
			...
			<td align="center"><?=iconChkBox($tableName, 'p_show', $razdel['p_show'], $razdel['id']);?></td>
			<td align="center"><?=iconChkBox($tableName, 'p_protect', $razdel['p_protect'], $razdel['id']);?></td>
