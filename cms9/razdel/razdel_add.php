...
<form method="post" enctype="multipart/form-data" action="/cms9/workplace.php?page=pages"  name="form1" id="form1">
	<table>
		...
		<tr>
			<td>Название (eng):</td>
			<td><input type="text" name="p_title_en" id="p_title" size=70 value=""></td>
		</tr>
		<?
		}
		?>
		...
		<tr>
			<td><!--Картинка в тексте-->Фоновое изображение (для текстовой страницы)</td>
	...
	<table width="100%">
		...
		<tr>
			<td>Title (eng):</td>
			<td><input type="text" name="p_meta_title_en" size=70 value=""></td>
		</tr>
		<tr>
			<td>Keywords (eng):</td>
			<td><input type="text" name="p_meta_kwd_en" size=70 value=""></td>
		</tr>
		<tr>
			<td>Description (eng):</td>
			<td><input type="text" name="p_meta_dscr_en" size=70 value=""></td>
		</tr>
		<?
		}
		?>
	...
	<input type="submit" class="bigSubmit" value="Сохранить" name="addPage" style=""  onClick="document.form1.action='index.php'; document.form1.target='_self'; MM_openBrWindow('/<?=$_VARS['cms_dir'];?>/log_write.php?text=<? echo "Добавлен раздел "; ?>'+document.getElementById('p_title').value,'logwin','width=100,height=100');">
</form>
</body>
</html>
