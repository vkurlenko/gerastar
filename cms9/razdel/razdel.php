...
function UpdRazdel(
	...
	$sql = "UPDATE `$razdel_table` 
			SET 
				...
				p_meta_title_en	= '$p_meta_title_en',
				p_meta_kwd		= '$p_meta_kwd',
				p_meta_kwd_en	= '$p_meta_kwd_en',
				p_meta_dscr		= '$p_meta_dscr',
				p_meta_dscr_en	= '$p_meta_dscr_en',
				p_add_text_1	= '$p_add_text_1',
				p_add_text_1_en	= '$p_add_text_1_en',
				p_tags			= '$p_tags',
				p_tpl			= '$p_tpl',
	...
	header('Location: /cms9/razdel/razdel_edit.php?id='.$id);
}
/******************************************/
/* /сохранение отредактированной страницы */
/******************************************/
