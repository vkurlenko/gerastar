...
<div id="mainDiv" class="tplMain">
	...
	<div id="content">
		<div class="main-content inner " >	
			...
			<?
			/*if($arrPage['p_parent_id'] == 0 && $_PAGE['p_url'] != 'about')
			{
				//echo 'корневая';
				include $_SERVER['DOCUMENT_ROOT'].'/blocks/level1.php';					
			}
			elseif($arrPage['p_parent_id'] != 0 && !empty($arrChild))
			{
				//echo 'второй уровень';
			...
			{*/
				//echo 'text';
				include $_SERVER['DOCUMENT_ROOT'].'/blocks/text.php';
			/*}*/			
			?> 
