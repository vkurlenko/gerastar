...
class Form
{
	public $formTpl 	= '';		// путь к файлу-шаблону формы 
		
	public $formAction 	= '';		// далее атрибуты формы
	public $formName 	= '';		//
	public $formClass 	= '';		//
	public $formId 		= '';		//
	...
	public $formData;					// массив данных полей формы
	public $formDataOpen	= '{'; 		// символ открытия шаблона для подстановки
	public $formDataClose	= '}'; 		// символ закрытия шаблона для подстановки
	public $formPrefixT 	= 'TITLE_'; // префикс названия поля
	public $formPrefixI 	= 'HTML_';  // префикс html поля
	
	public $formError   = array();		// массив сообщений об ошибках генерации формы
